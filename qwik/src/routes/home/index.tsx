...
export default component$(() => {
        ...
        const handleSubmitContact = $(async () => {
            ...
            if (Object.values(contactStore.valid).every((valid) => valid)){
                try {  
                    ...
                    console.error(error instanceof Error ? error.message : "Tatizo limetokea")
                } finally{
    ...
    <div class="bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
        ...
        <form id="contactForm" class="w-full max-w-lg bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md">
            <div class="mb-4">
